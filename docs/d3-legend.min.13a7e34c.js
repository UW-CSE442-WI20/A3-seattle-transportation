...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"d3-legend.min.js":[function(require,module,exports) {
var define;
...
!function a(b, c, d) {
  ...
  1: [function (a, b, c) {
    !function (a, d) {
      "object" == _typeof(c) && "undefined" != typeof b ? d(c) : "function" == typeof define && define.amd ? define(["exports"], d) : d(a.d3 = a.d3 || {});
    }(this, function (a) {
      "use strict";
      ...
      function g(a, b) {
        var c,
            ...
            j = 0;
        if (null == b) for (; ++i < e;) {
          isNaN(c = f(a[i])) || (d = c - g, g += d / ++j, h += d * (c - g));
        } else for (; ++i < e;) {
          isNaN(c = f(b(a[i], i, a))) || (d = c - g, g += d / ++j, h += d * (c - g));
        }
        if (j > 1) return h / (j - 1);
      }
      ...
      function i(a, b) {
        ...
        if (null == b) {
          ...
          for (; ++f < g;) {
            null != (d = b(a[f], f, a)) && (c > d && (c = d), e < d && (e = d));
          }
        }
      ...
      function p() {
        function a(a) {
          ...
          for (e = 0; e <= n; ++e) {
            o = p[e] = [], o.x0 = e > 0 ? l[e - 1] : j, o.x1 = e < n ? l[e] : k;
          }
      ...
      function v(a, c) {
        var d,
            ...
            h = -1;
        if (null == c) for (; ++h < g;) {
          isNaN(d = f(a[h])) || e.push(d);
        } else for (; ++h < g;) {
          isNaN(d = f(c(a[h], h, a))) || e.push(d);
        }
        return q(e.sort(b), .5);
      }
      ...
      function y(a) {
        for (var b = 0, c = a.length - 1, d = a[0], e = new Array(c < 0 ? 0 : c); b < c;) {
          e[b] = [d, d = a[++b]];
        }
      ...
      function B(a, b, c) {
        for (var d, e, f = (null == c ? a.length : c) - (b = null == b ? 0 : +b); f;) {
    ...
    !function (a, d) {
      ...
      var k = function k() {
        function a(b, d, e, f) {
          ...
          for (var g, j, l, m = -1, n = b.length, o = k[d++], p = c(), q = e(); ++m < n;) {
            (l = p.get(g = o(j = b[m]) + "")) ? l.push(j) : p.set(g, [j]);
          }
        ...
        return j = {
          ...
          sortKeys: function sortKeys(a) {
            return l[k.length - 1] = a, j;
          },
          sortValues: function sortValues(a) {
            return h = a, j;
          },
          rollup: function rollup(a) {
            return i = a, j;
          }
        };
      },
    ...
    !function (a, d) {
      ...
      c.prototype = b.prototype = {
        ...
        on: function on(a, b) {
              ...
              j = h.length;
          {
            if (!(arguments.length < 2)) {
              ...
              for (; ++i < j;) {
                if (c = (a = h[i]).type) g[c] = f(g[c], a.name, b);else if (null == b) for (c in g) {
                  g[c] = f(g[c], a.name, null);
                }
              }
        ...
        call: function call(a, b) {
          if ((c = arguments.length - 2) > 0) for (var c, d, e = new Array(c), f = 0; f < c; ++f) {
            e[f] = arguments[f + 2];
          }
  ...
  5: [function (a, b, c) {
    !function (a, d) {
      ...
      function d(a, b) {
        return function (c, d) {
          for (var e = c.length, f = [], g = 0, h = a[0], i = 0; e > 0 && h > 0 && (i + h + 1 > d && (h = Math.max(1, d - i)), f.push(c.substring(e -= h, e + h)), !((i += h + 1) > d));) {
            h = a[g = (g + 1) % a.length];
          }
        ...
        function b(a) {
          function b(a) {
            var b,
                ...
                j = r,
                q = s;
            if ("c" === o) q = u(a) + q, a = "";else {
              a = +a;
              var w = (a < 0 || 1 / a < 0) && (a *= -1, !0);
              if (a = u(a, n), w) for (b = -1, g = a.length, w = !1; ++b < g;) {
                if (h = a.charCodeAt(b), 48 < h && h < 58 || "x" === o && 96 < h && h < 103 || "X" === o && 64 < h && h < 71) {
                  w = !0;
                  break;
                }
              }
              if (j = (w ? "(" === e ? e : "-" : "-" === e || "(" === e ? "" : e) + j, q = q + ("s" === o ? t[8 + p / 3] : "") + (w && "(" === e ? ")" : ""), v) for (b = -1, g = a.length; ++b < g;) {
  ...
  6: [function (a, b, c) {
    !function (d, e) {
      "object" == _typeof(c) && "undefined" != typeof b ? e(c, a("d3-color")) : "function" == typeof define && define.amd ? define(["exports", "d3-color"], e) : e(d.d3 = d.d3 || {}, d.d3);
    }(this, function (a, b) {
      "use strict";
      ...
      function e(a, b, c) {
        return a = Math.pow(a, c), b = Math.pow(b, c) - a, c = 1 / c, function (d) {
      ...
      function i(a) {
        return function (c) {
          ...
          for (d = 0; d < f; ++d) {
            e = b.rgb(c[d]), g[d] = e.r || 0, h[d] = e.g || 0, i[d] = e.b || 0;
          }

          return g = a(g), h = a(h), i = a(i), e.opacity = 1, function (a) {
      ...
      function n(a, b, c, d) {
        ...
        return function (b, c) {
          var d = [],
              e = [];
          return b = a(b), c = a(c), f(b.translateX, b.translateY, c.translateX, c.translateY, d, e), g(b.rotate, c.rotate, d, e), h(b.skewX, c.skewX, d, e), i(b.scaleX, b.scaleY, c.scaleX, c.scaleY, d, e), b = c = null, function (a) {
      ...
      var v,
        ...
        return function (a) {
          ...
          G = function G(a, b) {
        var c = new Date();
        return a = +a, b -= a, function (d) {
          return c.setTime(a + b * d), c;
        };
      },
          H = function H(a, b) {
        return a = +a, b -= a, function (c) {
          return a + b * c;
        };
      },
          I = function I(a, b) {
        var c,
            d = {},
            e = {};
        null !== a && "object" == _typeof(a) || (a = {}), null !== b && "object" == _typeof(b) || (b = {});

        for (c in b) {
          c in a ? d[c] = M(a[c], b[c]) : e[c] = b[c];
        }
        ...
        var c,
            ...
            l = i - f,
            m = k * k + l * l;
        if (m < W) d = Math.log(j / g) / T, c = function c(a) {
    ...
    !function (d, e) {
      ...
      function r(a, b, c, d) {
        var e = a[0],
            ...
            g = b[0],
            h = b[1];
        return f < e ? (e = c(f, e), g = d(h, g)) : (e = c(e, f), g = d(g, h)), function (a) {
          return g(e(a));
        };
      }
      ...
      function s(a, c, d, e) {
        ...
        for (a[f] < a[0] && (a = a.slice().reverse(), c = c.slice().reverse()); ++i < f;) {
      ...
      function P(a, c, e, f, g, h, i, j, k) {
        ...
        var n = u(o, d.interpolateNumber),
            ...
            A = k("%B"),
            B = k("%Y"),
            C = [[i, 1, _], [i, 5, 5 * _], [i, 15, 15 * _], [i, 30, 30 * _], [h, 1, aa], [h, 5, 5 * aa], [h, 15, 15 * aa], [h, 30, 30 * aa], [g, 1, ba], [g, 3, 3 * ba], [g, 6, 6 * ba], [g, 12, 12 * ba], [f, 1, ca], [f, 2, 2 * ca], [e, 1, da], [c, 1, ea], [c, 3, 3 * ea], [a, 1, fa]];
    ...
    !function (a, d) {
        ...
        return function () {
          ...
          if (b) {
            for (var c, d = 0, e = -1, f = b.length; d < f; ++d) {
              c = b[d], a.type && c.type !== a.type || c.name !== a.name ? b[++e] = c : this.removeEventListener(c.type, c.listener, c.capture);
            }
      ...
      function m(a, b, c) {
            ...
            g = f.length;
        {
          ...
          if (h) for (var i, m = 0, n = h.length; m < n; ++m) {
            for (d = 0, i = h[m]; d < g; ++d) {
      ...
      function o() {
        for (var b, c = a.event; b = c.sourceEvent;) {
          c = b;
        }
      ...
      function t(a) {
        ...
        for (var b = this._groups, c = b.length, d = new Array(c), e = 0; e < c; ++e) {
          for (var f, g, h = b[e], i = h.length, j = d[e] = new Array(i), k = 0; k < i; ++k) {
            (f = h[k]) && (g = a.call(f, f.__data__, k, h)) && ("__data__" in f && (g.__data__ = f.__data__), j[k] = g);
          }
        }
      ...
      function C(a, b, c, d, e, f) {
        for (var g, h = 0, i = b.length, j = f.length; h < j; ++h) {
          (g = b[h]) ? (g.__data__ = f[h], d[h] = g) : c[h] = new A(a, f[h]);
        }
      ...
      function D(a, b, c, d, e, f, g) {
        ...
        for (h = 0; h < l; ++h) {
          (i = b[h]) && (n[h] = j = Ya + g.call(i, i.__data__, h, b), j in k ? e[h] = i : k[j] = i);
        }

        for (h = 0; h < m; ++h) {
          j = Ya + g.call(a, f[h], h, f), (i = k[j]) ? (d[h] = i, i.__data__ = f[h], k[j] = null) : c[h] = new A(a, f[h]);
        }
      ...
      function ha(a, b) {
        for (var c = fa(a), d = -1, e = b.length; ++d < e;) {
          c.add(b[d]);
        }
      }
      ...
      function La(a) {
        return "string" == typeof a ? new Ja([[document.querySelector(a)]], [document.documentElement]) : new Ja([[a]], Za);
      }
  ...
  9: [function (a, b, c) {
    !function (d, e) {
      "object" == _typeof(c) && "undefined" != typeof b ? e(c, a("d3-time")) : "function" == typeof define && define.amd ? define(["exports", "d3-time"], e) : e(d.d3 = d.d3 || {}, d.d3);
    }(this, function (a, b) {
      "use strict";
      ...
      function f(a) {
        function b(a, b) {
          return function (c) {
            ...
            for (c instanceof Date || (c = new Date(+c)); ++h < j;) {
              37 === a.charCodeAt(h) && (g.push(a.slice(i, h)), null != (e = da[d = a.charAt(++h)]) ? d = a.charAt(++h) : e = "e" === d ? " " : "0", (f = b[d]) && (d = f(c, e)), g.push(d), i = h + 1);
            }
        ...
        return Ja.x = b(sa, Ja), Ja.X = b(ta, Ja), Ja.c = b(ra, Ja), Ka.x = b(sa, Ka), Ka.X = b(ta, Ka), Ka.c = b(ra, Ka), {
          ...
          utcFormat: function utcFormat(a) {
            var c = b(a += "", Ka);
            return c.toString = function () {
              return a;
            }, c;
          },
          utcParse: function utcParse(a) {
            var b = f(a, d);
            return b.toString = function () {
              return a;
            }, b;
  ...
  11: [function (a, b, c) {
    ...
    function e() {
      function a(a) {
        var h = g.default.d3_calcType(b, z, m, o, s.format(t), w),
        ...
        var j = a.select("." + p + "legendCells").selectAll("." + p + "cell").data(h.data),
            D = j.enter().append("g").attr("class", p + "cell");
        D.append(c).attr("class", p + "swatch");
        var E = a.selectAll("g." + p + "cell " + c + "." + p + "swatch").data(h.data);
        g.default.d3_addEvents(D, C), j.exit().transition().style("opacity", 0).remove(), E.exit().transition().style("opacity", 0).remove(), E = E.merge(E), g.default.d3_drawShapes(c, E, e, d, f, A);
        var F = g.default.d3_addText(a, D, h.labels, p, x);
        j = D.merge(j);
        var G = F.nodes().map(function (a) {
          return a.getBBox();
        }),
            H = E.nodes().map(function (a) {
          return a.getBBox();
        });
        q ? E.attr("class", function (a) {
          return p + "swatch " + h.feature(a);
        }) : "line" == c ? E.style("stroke", h.feature) : E.style("fill", h.feature);
        var I = void 0,
            J = void 0,
            K = "start" == v ? 0 : "middle" == v ? .5 : 1;
        "vertical" === y ? !function () {
          var a = G.map(function (a, b) {
            return Math.max(a.height, H[b].height);
          });
          I = function I(b, c) {
            var d = (0, k.sum)(a.slice(0, c));
            return "translate(0, " + (d + c * l) + ")";
          }, J = function J(a, b) {
            return "translate( " + (H[b].width + H[b].x + u) + ", " + (H[b].y + H[b].height / 2 + 5) + ")";
          };
        }() : "horizontal" === y && (I = function I(a, b) {
          return "translate(" + b * (H[b].width + l) + ",0)";
        }, J = function J(a, b) {
          return "translate(" + (H[b].width * K + H[b].x) + ",\n          " + (H[b].height + H[b].y + u + 8) + ")";
        }), g.default.d3_placement(y, j, I, F, J, v), g.default.d3_title(a, r, p, B), j.transition().style("opacity", 1);
      }
      ...
      var b = (0, i.scaleLinear)(),
          ...
          q = !1,
          r = "",
          s = g.default.d3_defaultLocale,
          t = g.default.d3_defaultFormatSpecifier,
          u = 10,
          v = "middle",
          w = g.default.d3_defaultDelimiter,
          x = void 0,
          y = "vertical",
          z = !1,
          A = void 0,
          B = void 0,
          C = (0, h.dispatch)("cellover", "cellout", "cellclick");
      return a.scale = function (c) {
        ...
        return arguments.length ? (("rect" == b || "circle" == b || "line" == b || "path" == b && "string" == typeof d) && (c = b, A = d), a) : c;
        ...
        return arguments.length ? ("start" != b && "end" != b && "middle" != b || (v = b), a) : v;
      }, a.locale = function (b) {
        return arguments.length ? (s = (0, j.formatLocale)(b), a) : s;
      }, a.labelFormat = function (b) {
        return arguments.length ? (t = (0, j.formatSpecifier)(b), a) : a.locale().format(t);
        ...
        return arguments.length ? (b = b.toLowerCase(), "horizontal" != b && "vertical" != b || (y = b), a) : y;
  ...
  13: [function (a, b, c) {
    ...
    var d = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (a) {
      ...
      return b;
        ...
        i = function i(a, b) {
      a.each(function () {
        for (var a, c = (0, e.select)(this), d = c.text().split(/\s+/).reverse(), f = [], g = 1.2, h = (c.attr("y"), parseFloat(c.attr("dy")) || 0), i = c.text(null).append("tspan").attr("x", 0).attr("dy", h + "em"); a = d.pop();) {
          f.push(a), i.text(f.join(" ")), i.node().getComputedTextLength() > b && f.length > 1 && (f.pop(), i.text(f.join(" ")), f = [a], i = c.append("tspan").attr("x", 0).attr("dy", g + h + "em").text(a));
        }
      });
    },
        j = function j() {
      ...
      if ("object" === ("undefined" == typeof b ? "undefined" : d(b))) {
        ...
        for (var g = b.length; g < a.length; g++) {
          b.push(a[g]);
        }
      ...
      if ("function" == typeof b) {
        for (var h = [], i = a.length, j = 0; j < i; j++) {
          h.push(b({
            i: j,
            genLength: i,
            generatedLabels: a,
      ...
      return a;
        ...
        k = function k(a, b, c) {
      var d = [];
      if (b.length > 1) d = b;else for (var e = a.domain(), f = (e[e.length - 1] - e[0]) / (b - 1), g = 0; g < b; g++) {
        d.push(e[0] + g * f);
      }
      var h = d.map(c);
      return {
    ...
    c.default = {
      d3_drawShapes: function d3_drawShapes(a, b, c, d, e, f) {
      ...
      d3_addText: function d3_addText(a, b, c, d, e) {
        b.append("text").attr("class", d + "label");
        var f = a.selectAll("g." + d + "cell text." + d + "label").data(c).text(g);
        return e && a.selectAll("g." + d + "cell text." + d + "label").call(i, e), f;
      },
      d3_calcType: function d3_calcType(a, b, c, d, e, f) {
        var g = a.invertExtent ? l(a, e, f) : a.ticks ? k(a, c, e) : m(a),
            i = a.range && a.range() || a.domain();
        return g.labels = j(g.labels, d, a.domain(), i, f), b && (g.labels = h(g.labels), g.data = h(g.data)), g;
      },
      d3_filterCells: function d3_filterCells(a, b) {
      ...
      d3_placement: function d3_placement(a, b, c, d, e, f) {
        b.attr("transform", c), d.attr("transform", e), "horizontal" === a && d.style("text-anchor", f);
      },
      d3_addEvents: function d3_addEvents(a, b) {
      ...
      d3_title: function d3_title(a, b, c, d) {
        if ("" !== b) {
          var e = a.selectAll("text." + c + "legendTitle");
          e.data([b]).enter().append("text").attr("class", c + "legendTitle"), a.selectAll("text." + c + "legendTitle").text(b), d && a.selectAll("text." + c + "legendTitle").call(i, d);
          var f = a.select("." + c + "legendCells"),
              g = a.select("." + c + "legendTitle").nodes().map(function (a) {
            return a.getBBox().height;
          })[0],
              h = -f.nodes().map(function (a) {
            return a.getBBox().x;
          })[0];
          f.attr("transform", "translate(" + h + "," + g + ")");
        }
      },
      d3_defaultLocale: {
        format: f.format,
        formatPrefix: f.formatPrefix
      },
  ...
  14: [function (a, b, c) {
    ...
    function e() {
      function a(a) {
        var h = g.default.d3_calcType(b, w, f, m, p.format(q), t),
            i = a.selectAll("g").data([b]);
        ...
        var j = a.select("." + n + "legendCells").selectAll("." + n + "cell").data(h.data),
            A = j.enter().append("g").attr("class", n + "cell");
        A.append(c).attr("class", n + "swatch");
        var B = a.selectAll("g." + n + "cell " + c + "." + n + "swatch");
        g.default.d3_addEvents(A, z), j.exit().transition().style("opacity", 0).remove(), B.exit().transition().style("opacity", 0).remove(), B = B.merge(B), "line" === c ? (g.default.d3_drawShapes(c, B, 0, d), B.attr("stroke-width", h.feature)) : g.default.d3_drawShapes(c, B, h.feature, h.feature, h.feature, x);
        var C = g.default.d3_addText(a, A, h.labels, n, u);
        j = A.merge(j);
        var D = C.nodes().map(function (a) {
          return a.getBBox();
        }),
            E = B.nodes().map(function (a, d) {
          var e = a.getBBox(),
              f = b(h.data[d]);
          return "line" === c && "horizontal" === v ? e.height = e.height + f : "line" === c && "vertical" === v && (e.width = e.width), e;
        }),
        ...
        "vertical" === v ? !function () {
          var a = D.map(function (a, b) {
            return Math.max(a.height, E[b].height);
          }),
              b = "circle" == c || "line" == c ? E[0].height / 2 : 0;
          H = function H(c, d) {
            var f = (0, k.sum)(a.slice(0, d));
            return "translate(0, " + (b + f + d * e) + ")";
          }, I = function I(a, b) {
            return "translate( " + (G + r) + ",\n          " + (E[b].y + E[b].height / 2 + 5) + ")";
          };
        }() : "horizontal" === v && !function () {
          H = function H(a, b) {
            var d = (0, k.sum)(E.slice(0, b), function (a) {
              return a.width;
            }),
                f = "circle" == c || "line" == c ? F / 2 : 0;
          ...
          I = function I(b, c) {
            return "translate( " + (E[c].width * J + E[c].x) + ",\n              " + (a + r) + ")";
          };
        }(), g.default.d3_placement(v, j, H, C, I, s), g.default.d3_title(a, o, n, y), j.transition().style("opacity", 1);
      }
      ...
      var b = (0, i.scaleLinear)(),
          ...
          n = "",
          o = "",
          p = g.default.d3_defaultLocale,
          q = g.default.d3_defaultFormatSpecifier,
          r = 10,
          s = "middle",
          t = g.default.d3_defaultDelimiter,
          u = void 0,
          v = "vertical",
          w = !1,
          x = void 0,
      ...
      return a.scale = function (c) {
        ...
        return arguments.length ? ("rect" != b && "circle" != b && "line" != b || (c = b, x = d), a) : c;
      }, a.shapeWidth = function (b) {
        return arguments.length ? (d = +b, a) : d;
      }, a.shapePadding = function (b) {
        return arguments.length ? (e = +b, a) : e;
        ...
        return arguments.length ? (p = (0, j.formatLocale)(b), a) : p;
      }, a.labelFormat = function (b) {
        return arguments.length ? (q = (0, j.formatSpecifier)(b), a) : a.locale().format(q);
      }, a.labelOffset = function (b) {
        return arguments.length ? (r = +b, a) : r;
      }, a.labelDelimiter = function (b) {
        ...
        return arguments.length ? (b = b.toLowerCase(), "horizontal" != b && "vertical" != b || (v = b), a) : v;
      }, a.ascending = function (b) {
        return arguments.length ? (w = !!b, a) : w;
      }, a.classPrefix = function (b) {
        return arguments.length ? (n = b, a) : n;
  ...
  15: [function (a, b, c) {
    ...
    function e() {
      function a(a) {
        var h = g.default.d3_calcType(b, y, m, o, r.format(s), v),
            i = a.selectAll("g").data([b]);
        n && g.default.d3_filterCells(h, n), i.enter().append("g").attr("class", p + "legendCells");
        var j = a.select("." + p + "legendCells").selectAll("." + p + "cell").data(h.data),
            B = j.enter().append("g").attr("class", p + "cell");
        B.append(c).attr("class", p + "swatch");
        var C = a.selectAll("g." + p + "cell " + c + "." + p + "swatch");
        g.default.d3_addEvents(B, A), j.exit().transition().style("opacity", 0).remove(), C.exit().transition().style("opacity", 0).remove(), C = C.merge(C), g.default.d3_drawShapes(c, C, e, d, f, h.feature);
        var D = g.default.d3_addText(a, B, h.labels, p, w);
        j = B.merge(j);
        var E = D.nodes().map(function (a) {
          return a.getBBox();
        }),
            F = C.nodes().map(function (a) {
          return a.getBBox();
        }),
            G = (0, k.max)(F, function (a) {
          return a.height;
        }),
            H = (0, k.max)(F, function (a) {
          return a.width;
        }),
            I = void 0,
            J = void 0,
            K = "start" == t ? 0 : "middle" == t ? .5 : 1;
        "vertical" === x ? !function () {
          var a = E.map(function (a, b) {
            return Math.max(G, a.height);
          });
          I = function I(b, c) {
            var d = (0, k.sum)(a.slice(0, c));
            return "translate(0, " + (d + c * l) + " )";
          }, J = function J(a, b) {
            return "translate( " + (H + u) + ",\n              " + (F[b].y + F[b].height / 2 + 5) + ")";
          };
        }() : "horizontal" === x && (I = function I(a, b) {
          return "translate( " + b * (H + l) + ",0)";
        }, J = function J(a, b) {
          return "translate( " + (F[b].width * K + F[b].x) + ",\n              " + (G + u) + ")";
        }), g.default.d3_placement(x, j, I, D, J, t), g.default.d3_title(a, q, p, z), j.transition().style("opacity", 1);
      }
      ...
      var b = (0, i.scaleLinear)(),
          ...
          p = "",
          q = "",
          r = g.default.d3_defaultLocale,
          s = g.default.d3_defaultFormatSpecifier,
          t = "middle",
          u = 10,
          v = g.default.d3_defaultDelimiter,
          w = void 0,
          x = "vertical",
          y = !1,
          z = void 0,
          A = (0, h.dispatch)("cellover", "cellout", "cellclick");
      return a.scale = function (c) {
        return arguments.length ? (b = c, a) : b;
      }, a.cells = function (b) {
        return arguments.length ? ((b.length > 1 || b >= 2) && (m = b), a) : m;
        ...
        return arguments.length ? ("start" != b && "end" != b && "middle" != b || (t = b), a) : t;
      }, a.locale = function (b) {
        return arguments.length ? (r = (0, j.formatLocale)(b), a) : r;
      }, a.labelFormat = function (b) {
        return arguments.length ? (s = (0, j.formatSpecifier)(b), a) : a.locale().format(s);
      }, a.labelOffset = function (b) {
        return arguments.length ? (u = +b, a) : u;
      }, a.labelDelimiter = function (b) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","d3-legend.min.js"], null)
//# sourceMappingURL=/d3-legend.min.13a7e34c.js.map